...
type Mutation {
    criarMembro(nome: String!, email: String!): Membro!
    atualizarMembro(id: ID!, nome: String, email: String): Membro
...
-Body '{"query":"{ membros { id nome email } }"}' |(pode alterar dentro dos parenteses para retornar apenas os dados necessarios EX(nome email) vai retornar apenas o nome e o emailw)
